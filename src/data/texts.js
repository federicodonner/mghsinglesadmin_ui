const texts = {
  ...
  PAY: "Pagar",
  PAY_TITLE: "Pagar al cliente",
  PAY_OWED: "Dinero pendiente de cobro",
  PAY_AMOUNT: "Monto a pagar (pesos)",
  PAY_ALL: "Pagar todo",
  PAY_OVER: "No podés pagar más de lo que se le debe.",
  PAY_REMAINING: "Quedará pendiente",
  PAY_DONE: "Pago registrado",
  ...
  USERS_SEARCH: "Buscar por nombre o email",
  COL_PHONE: "Celular",
  COL_CREDIT: "Saldos",
  SALE_MONEY_SHORT: "En tienda:",
  STORE_CREDIT_SHORT: "Store credit:",
  USERS_EMPTY: "No hay cuentas en esta lista.",
  USERS_NONE_MATCH: "Ninguna cuenta coincide con la búsqueda.",
  ROWS_PER_PAGE: "Por página:",
  EDIT_USER: "Editar usuario",
  ADJUST_CREDIT: "Ajustar crédito",
  FULL_NAME: "Nombre",
  PHONE: "Celular",
  EMAIL_READONLY: "Email (no editable)",
  CURRENT_CREDIT: "Crédito actual",
  CURRENT_STORE_CREDIT: "Store credit actual",
  CREDIT_ADD: "Sumar",
  CREDIT_SUBTRACT: "Restar",
  CREDIT_AMOUNT: "Monto en pesos",
  CREDIT_NOTE: "Nota (opcional)",
  CREDIT_NEW_TOTAL: "Quedaría",
  CREDIT_ADJUSTED_OK: "Crédito ajustado.",
  USER_UPDATED_OK: "Datos actualizados.",
  VIEW_HISTORY: "Ver historial",
  HISTORY_TITLE: "Historial",
  HISTORY_EMPTY: "Este usuario no tiene movimientos todavía.",
  HIST_PURCHASE: "Compra",
  HIST_SALE: "Venta",
  HIST_CREDIT: "Crédito",
  HIST_PAYOUT: "Pago",
  HIST_CREDIT_USED: "Usado como crédito",
  HIST_CASH: "efectivo",
  ...
  REFILE_DONE: "Listo",
  UNPRICED_TITLE: "Cartas sin precio",
  UNPRICED_HINT:
    "Estas cartas están en stock pero no tienen precio, así que los clientes no las ven. Ponéles precio:",
  SET_PRICE: "Establecer precio",
  PRICE_SET: "Precio establecido.",
  REVERT_TO_CK: "Volver al precio de CardKingdom cuando esté disponible",
  REVERT_ON_HINT:
    "Cuando CardKingdom tenga un precio para esta carta, se va a usar ese en lugar de este.",
  REVERT_OFF_HINT:
    "Este precio queda fijo hasta que lo cambies a mano, aunque CardKingdom la liste después.",
  IN_STOCK: "en stock",
